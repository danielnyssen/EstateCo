...
var NOTIFY_EMAIL = 'daniel.nyssen@gmail.com';
var BUSINESS_EMAIL = 'contactus@estateco.com.au';
...
function handleLead(data) {
  ...
  sendBusinessEmail(data, folderUrl);
...
function sendBusinessEmail(data, folderUrl) {
  MailApp.sendEmail({
    to: NOTIFY_EMAIL,
